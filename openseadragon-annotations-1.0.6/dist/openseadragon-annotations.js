...
(OpenSeadragon.Viewer = OpenSeadragon.Viewer || {}),
  ...
  \***********************************/,
    function (e, t, n) {
      "use strict";
      function i(e, t, n) {
        t.dispatch({ type: "ACTIVITY_UPDATE", inProgress: !1 }),
          n.getMode() !== e && t.dispatch({ type: "MODE_UPDATE", mode: e });
      }
      ...
      !(function (e, n) {
        ...
        function d(e, n, i) {
          ...
          n &&
            ...
            a(e) ||
              ("className" in n &&
                ((n.class = n.className), delete n.className),
              (u = n.class) && !c(u) && (n.class = s(u))));
        ...
        function f(e, t) {
          return d(
            e.nodeName,
            n(i(e.attributes), t),
            arguments.length > 2 ? r(arguments, 2) : e.children
          );
        }
        function h(e, t, n) {
          var i = t.split("."),
          ...
          return function (t) {
            ...
            if (
              (c(n)
                ? ((s = o(t, n)), u(s) && (f = f._component) && (s = o(f, n)))
                : (s = f.nodeName
                    ? (f.nodeName + f.type).match(/^input(check|rad)/i)
                      ? f.checked
                      : f.value
                    : t),
              a(s) && (s = s.call(f)),
        ...
        function v(e, t, n, i, o) {
          if (
            ((M(e)[t] = n),
            "key" !== t && "children" !== t && "innerHTML" !== t)
          )
            if ("class" !== t || o)
              if ("style" === t) {
                if (
                  ((!n || c(n) || c(i)) && (e.style.cssText = n || ""),
                  n && "object" == typeof n)
                ) {
                  if (!c(i)) for (var r in i) r in n || (e.style[r] = "");
                  for (var r in n)
                    e.style[r] =
                      "number" != typeof n[r] || te[r] ? n[r] : n[r] + "px";
                }
                ...
                (t = H(t.substring(2))),
                  n
                    ? s[t] || e.addEventListener(t, E)
                    : s[t] && e.removeEventListener(t, E),
                  (s[t] = n);
              } else if ("type" !== t && !o && t in e)
                w(e, t, u(n) ? "" : n), l(n) && e.removeAttribute(t);
              else {
        ...
        function y(e) {
          for (var t = {}, n = e.attributes.length; n--; )
        ...
        function R(e, t) {
          return c(t)
            ...
            ? N(e, t.nodeName)
            : a(t.nodeName)
            ? e._componentConstructor === t.nodeName || g(t)
            : void 0;
        }
        function N(e, t) {
        ...
        function U(e) {
          var t = e.nodeName.defaultProps,
            o = i(t || e.attributes);
          return (
            t && n(o, e.attributes), e.children && (o.children = e.children), o
          );
        }
        function D(e) {
          O(e);
        ...
        function O(e) {
          I(e),
            1 === b(e) &&
              (M(e, y(e)), (e._component = e._componentConstructor = null));
        }
        function j() {
          for (var e; (e = re.pop()); )
        ...
        function Y(e, t, n, i, o, r, a) {
          ...
          var c = B(e, t, n, i, r);
          return (
            o && c.parentNode !== o && o.insertBefore(c, a || null),
            --ae || j(),
            c
          );
        }
        function B(e, t, n, i, o) {
          ...
          if (
            (c(d) || (d = String(d)), (l = "svg" === H(d)), l && (ce = !0), e)
          ) {
            if (!N(e, d)) {
          ...
          return (
            t.children &&
            1 === t.children.length &&
            "string" == typeof t.children[0] &&
            1 === s.childNodes.length &&
            s.firstChild instanceof Text
        ...
        function T(e, t, n, i) {
          ...
          if (g)
            for (var m = 0; m < g; m++) {
              ...
              (c = B(c, a, n, i)),
                c !== l[m] && e.insertBefore(c, l[m] || null);
            }
        ...
        function x(e, t) {
          ...
          n
            ? P(n, !t)
            : (e[ee] && e[ee].ref && e[ee].ref(null),
              t || D(e),
              e.childNodes && e.childNodes.length && k(e.childNodes, t));
        }
        function Z(e, t) {
          var n = e[ee] || y(e);
        ...
        function W(e, t, n, i, o) {
          ...
          e._disableRendering ||
            ...
            0 !== n &&
              (1 !== n && !1 === q.syncComponentUpdates && r
                ? S(e)
                : C(e, 1, o)),
            e.__ref && e.__ref(e));
        }
          ...
          if (!e._disableRendering) {
            ...
            if (
              (p &&
                ...
                !1 === e.shouldComponentUpdate(u, l, s)
                  ? (r = !0)
                  : e.componentWillUpdate && e.componentWillUpdate(u, l, s),
                (e.props = u),
                (e.state = l),
                (e.context = s)),
              ...
              for (
                e.render && (c = e.render(u, l, s)),
                  e.getChildContext && (s = n(i(s), e.getChildContext()));
                g(c);
              ...
              if (a(E) && E.prototype.render) {
                ...
                var N = A;
                (v = I),
                  v && (N = e._component = null),
                  (A || 1 === t) &&
                    (N && (N._component = null),
                    (w = Y(N, c, s, o || !p, M, !0, A && A.nextSibling)));
              }
              if (
                (A &&
                  w !== A &&
            ...
            !p || o
              ? (re.unshift(e), ae || j())
              : !r && e.componentDidUpdate && e.componentDidUpdate(d, f, h);
            var O,
        ...
        n(z.prototype, {
          ...
          setState: function (e, t) {
            var o = this.state;
            this.prevState || (this.prevState = i(o)),
              n(o, a(e) ? e(o, this.props) : e),
              t &&
        ...
        h = (function () {
          function e(t) {
            ...
            o(this, e),
              ...
              (this.btn = new a.Button(
                (0, a.extend)({ onClick: this.onClick }, t)
              )),
          ...
          return (
            r(e, [
              ...
              },
              {
                key: "onClick",
                value: function (e) {
                  e.eventSource.Tooltip &&
                    (0, u.default)(
                      e.eventSource.Tooltip.toUpperCase(),
                      f.default,
                      s.default
                    );
                },
  ...
  \******************************/,
    function (e, t) {
      ...
      function a() {
        A &&
          h &&
          ((A = !1), h.length ? (p = h.concat(p)) : (g = -1), p.length && c());
      }
      function c() {
        if (!A) {
          var e = o(a);
    ...
    function (e, t, n) {
      ...
      function i(e) {
        e.dispatch({ type: "ACTIVITY_UPDATE", inProgress: !1 }),
          e.dispatch({ type: "ANNOTATIONS_RESET", annotations: [] });
      }
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = i);
    } /*!***************************************!*\
  ...
  \***************************************/,
    function (e, t, n) {
      ...
      function i(e, t) {
        t.dispatch({ type: "ACTIVITY_UPDATE", inProgress: !1 }),
          t.dispatch({ type: "ANNOTATIONS_RESET", annotations: e });
      }
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = i);
    } /*!***********************************!*\
          ...
          return (
            u() ||
              (e = function (e) {
                var t = e;
                return (
                  (t[1]["stroke-width"] = y.convertWidth.toPercent(3)),
                  d.h.apply(void 0, c(t))
                );
              }),
            e
          );
          ...
          return (
            ...
            s(t, [
              ...
              },
              {
                ...
                value: function (e) {
                  h.default.notInMoveMode() &&
                    (e.stopPropagation(), (0, m.default)(A.default, h.default));
                },
              },
              {
                key: "handleMouseUp",
                value: function (e) {
                  h.default.notInMoveMode() &&
                    (e.stopPropagation(), (0, E.default)(A.default, h.default));
                },
              },
              {
                key: "coords",
              ...
              },
              {
                ...
                value: function (e) {
                  h.default.notInMoveMode() &&
                    ...
                    v.default.apply(
                      void 0,
                      c(this.coords(e)).concat([A.default, h.default])
                    ));
                },
              },
              {
  ...
  \******************************/,
    function (e, t, n) {
      ...
      function i(e, t, n, i) {
        switch (i.getMode()) {
          case "DRAW":
            n.dispatch({ type: "ACTIVITY_UPDATE", inProgress: !0 }),
              n.dispatch({
    ...
    function (e, t, n) {
      ...
      function o(e) {
        return function () {
          ...
          throw new Error(
            "The OpenSeadragon Annotations plugin is not running"
          );
        };
      }
      Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (a.default.Viewer.prototype.initializeAnnotations = function (e) {
        var t = this,
          ...
          i = function () {
            ...
            (0, m.default)(
              { zoom: a, width: u.width, height: u.height },
              h.default
            ),
        ...
        if (U)
          throw new Error(
            "The OpenSeadragon Annotations plugin is already running"
          );
        if (O) throw new Error("An existing overlay has been found");
        this.isOpen()
          ? i()
          : (D && this.removeHandler("open", D),
            (D = i),
            this.addOnceHandler("open", i));
      }),
        ...
        (a.default.Viewer.prototype.shutdownAnnotations = o(function () {
          if (null !== D)
            throw new Error(
              "An untriggered handler for the 'open' event has been found"
            );
          if (null === O) throw new Error("Null reference to the SVG overlay");
          this.removeHandler("zoom", G),
            (G = null),
